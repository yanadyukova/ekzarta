...
export function caching() {
    return gulp.src([
            ...
            '!' + config.resources + '/views/public/**/*',
            '!' + config.resources + '/views/admin/**/*.php',
            '!' + config.resources + '/views/emails/**/*.php',
            config.resources + '/views/public/desktop/**/*.php',
            config.resources + '/views/public/layouts/**/*.php',
            config.resources + '/views/public/mobile/**/*.php',
        ])
...
export function cssFont() {
  return gulp.src([config.app + '/css/fonts.css'])
    .pipe(plugins.plumber({errorHandler: onError}))
...
export function gitCommitCacheResources() {
    return gulp.src('./git/*')
        ...
        .pipe(plugins.git.commit('Update cache', {args: '-m'}).on('error', function(err) {
            gutil.beep();
            if (err) throw err;
        }));
}
 ...
 * Build
 */
const buildHTML = gulp.series(templateToHTML, htmlHint);
