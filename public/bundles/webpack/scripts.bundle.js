...
function countTransactionCosts(year) {
    ...
    for (specialist in packages[selectPackage]['specialists']) {
        transaction_costs += packages[selectPackage]['specialists'][specialist] * fixed_costs[specialist] * 12 + packages[selectPackage]['specialists'][specialist] * fixed_costs[specialist] * 12 * 0.302;
    }
